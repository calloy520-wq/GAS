...
2. 聚焦當下最關鍵的一兩處，以情感、神態與氛圍烘托為主，重意境留白與餘韻，❌絕對禁止逐一點名全身部位、禁止視/觸/嗅/聽四感清單式鋪滿、禁止器官逐格交代，寧可少寫精寫、點到為止；台詞被嬌喘打斷，勿一氣呵成。
3. 器官依配對裁決：無陽具填無「肉棒」、無陰道填無「蜜穴」。絕對禁止插入式陽具，以手指/舌/器物替代，嚴禁憑空生出男性器官。
4. physical_state欄位key固定用數字代碼(1=陰道 2=陽具 3=後穴 4=右手 5=左手)，禁用文字key，其餘進narration。據實填當下肉體狀態，未被碰該代碼不填；脫離接觸改寫「鬆開/餘韻」。★此欄純為系統狀態記錄，narration敘事【絕對禁止】比照逐格謄寫每個部位狀態，敘事仍以第2條為準、聚焦留白。
