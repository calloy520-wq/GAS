...
var LEGEND_SHIPS = [
  { id:'ghost', nm:'亡者迴響', ico:'👻', tier:4, gunTier:5,
    ...
    hint:{ nav:3 }, rumor:'酒館角落，一名獨眼老水手壓低聲音：「夜霧海域…有艘沒有活人的船在打轉。夠格的航海家才追得上。」',
  ...
  { id:'golden', nm:'大金鹿號', ico:'🪙', tier:4, gunTier:3,
    ...
    hint:{ com:3 }, rumor:'碼頭商人神秘兮兮：「百年前沉沒的黃金船隊…有人拼出了半張海圖。有本錢的商人才玩得起這場打撈。」',
  ...
  { id:'dragon', nm:'海龍王', ico:'🐉', tier:4, gunTier:6,
    ...
    hint:{ deepest:10 }, rumor:'一位斷了腿的老探險家盯著你：「最深的海溝底下…睡著一頭古龍的骸骨。夠深、夠有名望的人，才聽得懂它的呼喚。」',
