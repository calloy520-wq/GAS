...
function SEED_ITEMS() {
  return [
    ...
    ['IT10','淚滴奧秘杖', 'weapon',    3, 0, 20, 'LOCKED', '露露卡的變身法杖，奧秘之力，智謀大增']
  ];
}
...
function SEED_LEGENDS() {
  return [
    ...
    ['L4', '森亞露露卡', 'LOCKED', 'mage', 6, 0, 100, 100, 120, 'shadow', '', 0, 1, 0, '',
      '前天才偵探、如今幻影怪盜「Cure Arcana·Shadow」。三無冷嬌、我行我素，話少卻內藏熾熱情感，實力深不可測。',
      '話極少、面無表情，偶爾一句道破真相；語氣淡然。', '冰淇淋（大胃王甜食控）、貓；別號 露露卡/rrk/llk。',
      '「……謊言，到此為止。變身，Cure Arcana·Shadow。」', '來自 1999 真未來市的天才偵探 Precure，以淚滴奧秘杖變身，隱身幻影怪盜團、另有目的。']
  ];
}
